...
def test_year():
    ...
    assert start == pd.Timestamp(
        '2019-01-01 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    assert end == pd.Timestamp(
        '2020-01-01 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
...
def test_month():
    ...
    assert type(end) == pd.Timestamp
    assert start == pd.Timestamp(
        '2020-07-01 00:00:00+0700', tz='Asia/Novosibirsk')
    assert end == pd.Timestamp(
        '2020-08-01 00:00:00+0700', tz='Asia/Novosibirsk')
    start, end = prepare_period(tz=tz, month=7, year=2017)
    assert type(start) == pd.Timestamp
    assert type(end) == pd.Timestamp
    assert start == pd.Timestamp(
        '2017-07-01 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    assert end == pd.Timestamp(
        '2017-08-01 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
...
def test_date():
    ...
    assert type(end) == pd.Timestamp
    assert start == pd.Timestamp(
        '2020-04-17 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    assert end == pd.Timestamp(
        '2020-04-18 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    ...
    assert type(end) == pd.Timestamp
    assert start == pd.Timestamp(
        '2017-04-17 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    assert end == pd.Timestamp(
        '2017-04-18 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    ...
    assert type(end) == pd.Timestamp
    assert start == pd.Timestamp(
        '2017-05-17 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    assert end == pd.Timestamp(
        '2017-05-18 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
...
def test_period():
    ...
    assert type(end) == pd.Timestamp
    assert start == pd.Timestamp(
        '2017-06-12 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
    assert end == pd.Timestamp(
        '2017-12-06 00:00:00+0700',
        tz='Asia/Novosibirsk'
    )
...
def test_empty_date():
    ...
    assert type(start) == pd.Timestamp
    assert type(end) == pd.Timestamp
    assert start.date() == pd.Timestamp(
        datetime.datetime.now(),
        tz='Asia/Novosibirsk'
    )
    assert end.date() == pd.Timestamp(
